...
var inputName = document.querySelector('.modal__name input[id="call-name"]');
var buttonModal = document.querySelector('.main-header__button');
...
var phoneInput = document.querySelector('.phone input[id="phone"]');

// Создаем маску в инпуте
var phoneMask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](phoneInput, {
  mask: '+{7}(000)000-00-00'
});
var modalPhone = document.querySelector('.modal__phone input[id="call-phone"]');
